...
import { Plus, MoreHorizontal, Eye, Edit, Trash2, Upload } from "lucide-react"
...
export function getColumns(session: any, router: any, toast: any, refreshTable: () => void): ColumnDef<Vehicle>[] {
  return [
    {
      accessorKey: "type",
      header: "Type",
